...
our reported 14.45% → 8.50% WER. Model predictions have not been generated yet.
...
기존 한국 아동 Test 성능 수치와 별개의 외부 데모입니다. 아직 모델 전후 추론을
실행하지 않았습니다. 제공 문장은 문법을 수정하지 않고 그대로 보존했습니다.
